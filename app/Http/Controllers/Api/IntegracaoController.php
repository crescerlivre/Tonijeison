...
class IntegracaoController extends Controller
{
    public function sendText(Request $request)
    {
        try {
            ...
            /*  
                //não seria assim não?
                $session = Sessions::where('session_key', $request->session_key)->where('user_id', auth()->user()->id)->first();
            */
            ...
            return response()->json(['error' => true, 'data' => $th->getMessage(), 'message' => 'Sessão não encontrada ou desconectada acesse: https://divulgawhatsapp.com.br/painel/sessions.'], 401);
        }
    }
