                ...
                <form method="post" class="row" action="{{ route('users.update', $user->id) }}">
                    ...
                    <div class="mb-3  col-3">
                        ...
                        <select class="form-control" name="server_whatsapp" id="server_whatsapp">
                            <option value="https://whatsapp-novatravel.apibrasil.com.br/"  @if($user->server_whatsapp == 'https://whatsapp-novatravel.apibrasil.com.br/') selected @endif>Servidor NovaTravel</option>
